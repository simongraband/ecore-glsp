...
#COPY --from=client-builder usr/src/client/browser-app .

#COPY --from=client-builder usr/src/client/theia-ecore .

#COPY --from=client-builder usr/src/client/package.json .
#COPY --from=client-builder usr/src/client/lerna.json .
#COPY --from=client-builder usr/src/client/tslint.json .

#COPY --from=client-builder usr/src/client/configs .

COPY --from=client-builder usr/src/client .
